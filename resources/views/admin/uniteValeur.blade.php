<x-layout>
    ...
    <div class="filter">
        <div class="flex justify-between">
            ...
            <div class="font-bold">
                <form method="get" action="{{ route('uniteValeurs') }}" id="form" class="px-3 text-white grid-cols-5 content flex gap-3 items-center justify-around bg-orange-400 py-2">
                    @csrf
                    <h3>Filtrer par:</h3>
                ...
                <tbody>
                    @forelse ($unitevaleurs as $unitevaleur)
                        <tr>
                            ...
                            <td scope="row"> <a href="{{ route('unitevaleur.show', ['unitevaleur' => $unitevaleur]) }}" class="text-blue-600 hover:text-blue-900">Voir</a> </td>
                            <td scope="row"> <a href="{{ route('unitevaleur.edit', ['unitevaleur' => $unitevaleur]) }}" class="text-green-600 hover:text-green-900">Editer</a> </td>
                        </tr>
                    @empty
                        <tr>
